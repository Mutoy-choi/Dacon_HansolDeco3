...
3.  **RAG 성능 개선:**
    ...
    *   **Zero-Shot-CoT 프롬프팅:** 데이터 노이즈를 고려하여, 5-shot 예시를 제공하고고 **Zero-Shot-CoT** ("하나씩 차근차근 생각한 뒤...") 프롬프트를 사용하여 Qwen-32B 모델의 일반화된 단계적 추론 능력을 유도했습니다. (향후 정제된 데이터에는 구체적인 추론 단계 지정이 유리할 수 있음)
